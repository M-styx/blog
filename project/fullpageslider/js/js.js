...
function tiemi1move(){
	...
	mTween(p1,'top',170,600,'easeOut',function(){
		$('.ti_p1').fadeIn(500);
		mTween(p2,'top',250,600,'easeOut');
		$('#go').fadeIn();
		mTween(go,'top',300,600,'easeOut');
		$('#bg').fadeIn(1000);
...
function tiemi2move(){
	...
	$('#ti_img2').fadeIn(2000);
	$('#ti_img3').fadeIn(500);
	mTween(img1,'top',24,800,'easeOut');
	mTween(img3,'top',180,800,'easeOut',function(){
		$('#cl').fadeIn(1000);
	});
	mTween(img2,'top',140,1000,'easeOut');
}
...
function tiemi3move(){
	...
	$('#ti3_img1')[0].style.transform = 'scale(0.5)';
	...
	mTween(img2,'top',280,1000,'easeOut',function(){
