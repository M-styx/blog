!function (t) {
  ...
  var p = navigator.appName, h = navigator.appVersion, v = h.split(";");
  if (v[1]) {
    var m = v[1].replace(/[ ]/g, "");
    "Microsoft Internet Explorer" == p && "MSIE8.0" == m && (skills.temp = "columns")
  }
  var g = {userInfo: userInfo, skills: skills, timeAxis: timeAxisArr, casees: casees, projects: projects};
  ...
  !function () {
    ...
    function a(t, e) {
      if (p(t))for (var s = 0, i = t.length; s < i; s++)e.call(t, t[s], s, t); else for (s in t)e.call(t, t[s], s)
    }

    function r(t, e) {
      var s = /(\/)[^\/]+\1\.\.\1/, i = ("./" + t).replace(/[^\/]+$/, ""), n = i + e;
      for (n = n.replace(/\/\.\//g, "/"); n.match(s);)n = n.replace(s, "/");
      return n
    }

    function o(t, s) {
      var i = e.get(t) || c({filename: t, name: "Render Error", message: "Template not found"});
      return s ? i(s) : i
    }
    ...
    function c(t) {
      var e = "{Template Error}", s = t.stack || "";
    ...
    var u = e.cache = {}, d = this.String, f = {
      ...
      $helpers: {}, $include: function (t, e, s) {
        return t = r(s, t), o(t, e)
      }, $string: s, $escape: n, $each: a
  ...
  s(4), s(5), s(6), s(7), s(8), s(10), s(11), t.exports = i("init", function (t, e) {
    "use strict";
    var s = this, i = (s.$helpers, function (i, n) {
      n = n || t;
      var a = s.$include(i, n, e);
      return o += a
    }), n = t.skills, a = t.timeAxis, r = t.projects, o = "";
  ...
  t.exports = i("hea_intro", function (t, e) {
    "use strict";
    var s = this, i = s.$helpers, n = t.userInfo, a = s.$string, r = t.images, o = t.icon, l = t.intro_03, c = s.$each, u = (t.$value, t.$index, "");
  ...
  t.exports = i("skills-1", function (t, e) {
    "use strict";
    var s = this, i = s.$helpers, n = s.$each, a = t.skills, r = (t.$value, t.$index, s.$string), o = t.len, l = "";
    return l += ' <div class="skills"> <div class="skills_top"> <div class="top_con"> <div class="skills_title"> <h3>技能展示</h3> <p>致力于编写艺术般的代码</p> </div> <div class="top_detail clearfix"> <div class="left"> ', n(a.pageArr, function (t, e) {
  ...
  t.exports = i("skills-2", function (t, e) {
    "use strict";
    var s = this, i = (s.$helpers, s.$each), n = t.skills, a = (t.$value, t.$index, s.$string), r = "";
  ...
  t.exports = i("timeAxis-1", function (t, e) {
    "use strict";
    var s = this, i = s.$helpers, n = s.$each, a = t.timeAxis, r = (t.$value, t.$index, s.$string), o = t.nums, l = "";
  ...
  s(9), t.exports = i("case", function (t, e) {
    "use strict";
    var s = this, i = s.$helpers, n = s.$each, a = t.casees, r = (t.$value, t.$index, s.$string), o = function (i, n) {
      n = n || t;
      var a = s.$include(i, n, e);
      return l += a
    }, l = "";
  ...
  t.exports = i("case_right_temp", function (t, e) {
    "use strict";
    var s = this, i = (s.$helpers, s.$string), n = t.caseTitle, a = t.publishTime, r = t.caseDescription, o = t.caseThumbnail, l = t.caseWebsite, c = "";
  ...
  t.exports = i("project", function (t, e) {
    "use strict";
    var s = this, i = (s.$helpers, s.$each), n = t.projects, a = (t.$value, t.$index, s.$string), r = "";
    return r += '<div class="project"> <div class="bts"> <h2 class="bt">作品及毕业设计</h2> <h3 class="smallbt">业余项目与公司项目相互促进</h3> </div> ', i(n, function (t, e) {
  ...
  var i = s(2);
  t.exports = i("footer", '<div class="footer"> <div class="footcon clearfix"> <div class="footleft"> <p>最后更新于2016年9月13日</p> <p>联系人：马川，电话：13581628575</p> </div>  </div> </div>')
}, function (t, e, s) {
  function i(t, e) {
  ...
  function n() {
    var t = B.clientHeight, e = R.scrollHeight;
  ...
  function o() {
    var t = U.clientHeight, e = Y.scrollHeight;
  ...
  function l() {
    var t = f.$("img", Y)[0], e = t.getAttribute("_src");
    if ("" !== e) {
      var s = new Image;
      s.onload = function () {
        t.src = this.src;
        var e = t.offsetWidth, s = t.offsetHeight, i = e / 560;
  ...
  var d = s(1), f = s(13), p = s(14), h = s(15), v = s(2);
  ...
  if (document.getElementById("intro_table").style.height = m + "px", "circle" === d.skills.temp) {
    for (var g = (f.$(".skills")[0], f.$(".top_detail")[0]), y = f.$(".left", g)[0], b = f.$(".pages", y)[0], x = f.$("li", b), _ = f.$(".skillLanguage", y), C = 0, W = 0; W < x.length; W++)x[W].index = W, f.addEvent(x[W], "mouseover", function (t) {
      if (C !== this.index) {
        var e = this;
        h(_[C], {opacity: 0}, 300, "linear", function () {
          _[C].style.display = "none", _[e.index].style.display = "block", h(_[e.index], {opacity: 1}, 300, "linear"), C = e.index
    ...
    var A = {
      W: 590, data: $, animationEnd: function () {
        h(y, {opacity: 1}, 30)
      }
    };
    setTimeout(function () {
  ...
  } else if ("columns" === d.skills.temp)for (var E = f.$(".bottom_detail")[0], T = f.$(".detail", E), W = (f.$(".subject_circle", T[0])[0], f.$(".subject_con", T[0])[0], 0); W < T.length; W++)!function (t) {
    setTimeout(function () {
      var e = T[t].getAttribute("data-width");
      h(T[t], {width: e}, 500, "elasticBoth", function () {
      })
    }, 50 * t)
  }(W), T[W].onmouseover = function () {
    var t = f.$(".subject_circle", this)[0], e = f.$(".boxbg", this)[0], s = f.$(".subject_con", this)[0];
    s.style.display = "block", t.style.display = "block", e.style.display = "block", s.style.left = t.offsetLeft - s.offsetWidth / 2 + "px", h(s, {opacity: 1}, 500), h(t, {opacity: 1}, 500), h(e, {opacity: 1}, 500)
  }, T[W].onmouseout = function () {
    var t = f.$(".subject_circle", this)[0], e = f.$(".subject_con", this)[0], s = f.$(".boxbg", this)[0];
    h(e, {opacity: 0}, 500, "linear", function () {
      e.style.display = "none", t.style.display = "none", s.style.display = "none"
    }), h(t, {opacity: 0}, 500), h(s, {opacity: 0}, 500)
  };
  var M = f.$(".case_left")[0], I = f.$("ul", M), S = f.$("li", M), j = f.$("em", M), P = f.$(".case_main")[0], L = f.$(".case_list_main")[0], D = null;
  f.addEvent(L, "click", function (t) {
    ...
    if (f.parents(e, ".case_listbt1")) {
      ...
      if (o === D)return;
      var c = i(casees, o), u = v("case_right_temp", c);
      setTimeout(function () {
        Y.innerHTML = u
  ...
  var M = f.$(".case_left")[0], H = f.$(".list_scroll")[0], O = f.$(".list_bar")[0], B = M, R = L, Q = O, V = H, q = 0, F = 0;
  ...
  var J = f.$(".right_srcoll")[0], z = f.$(".right_bar")[0], U = f.$(".right_main")[0], Y = f.$(".content", U)[0], G = 0, K = 0;
  setTimeout(function () {
    o()
  }, 0);
  ...
  var s = function () {
    var t = {
      $: function (t, e) {
        ...
        if ("#" === e.charAt(0))for (; t.id !== e.slice(1);)t = t.parentNode; else if ("." === e.charAt(0))for (; t && 9 !== t.nodeType && !s.hasClass(t, e.slice(1));)t = t.parentNode; else for (; t && 9 !== t.nodeType && t.nodeName.toLowerCase() !== e;)t = t.parentNode;
        ...
        var i = s.getEleRect(t), n = s.getEleRect(e), a = i.width, r = i.height, o = i.left, l = i.top, c = n.width, u = n.height, d = n.left, f = n.top;
  ...
  s.fn = s.prototype = {
    constructor: s, animationEnd: null, init: function (t) {
      ...
      var a = this, r = a.data[t][1].toString().length > 4 ? 1 : 0, o = this.onOff ? 1 : 0;
      s()
    }, eachOther: function () {
      var t = this;
